...
mksquashfs "${WORK}"/rootfs "${CASPER}"/filesystem.squashfs -noappend -comp xz 
...
menuentry \"Gnoppix GUI\" {
linux /casper/vmlinuz boot=casper $KERNEL_PARAMS fsck.mode=skip quiet splash --
initrd /casper/initrd.img
}

menuentry \"Gnoppix in safe mode\" {
